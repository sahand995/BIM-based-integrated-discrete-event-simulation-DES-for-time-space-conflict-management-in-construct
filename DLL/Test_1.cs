...
public class Test_1 : MonoBehaviour
{
    ...
    private float largeTruckLoading;
    ...
    void Start()
    {
        ...
        start_Pos_x = GetComponent<Loading>().goal_Pos_x;
        start_Pos_z = GetComponent<Loading>().goal_Pos_z;
        ...
        string str = "Path to Dump site for BLUE one : ";
        ...
        print($"Distance between LoadingPoint to DumpingPoint for BLUE one: {InformedRRTStar.get_path_len(path):F3} m");


        //Draw Line between nodes
        lineRenderer = GetComponent<LineRenderer>();
        lineRenderer.positionCount = path.Count + GetComponent<Loading>().Getpath_line().Count - 1;
        ...
        {
            lineRenderer.SetPosition(i + path.Count - 1, new Vector3(Convert.ToSingle(GetComponent<Loading>().Getpath_line()[i].x), 0.5f, Convert.ToSingle(GetComponent<Loading>().Getpath_line()[i].y)));
        }
        ...
        path_Reverse_1 = priorityObject.GetComponent<Hauling_1>().Getpath();
        b_1 = priorityObject.GetComponent<Hauling_1>().Get_b();
        m_1 = priorityObject.GetComponent<Hauling_1>().Get_m();
        ...
        {
            EditorUtility.DisplayDialog("warning!", "There is not a intersection point from Loading Site to Dumping Site in the path of two objects.", "ok");
            Warning = true;
        }

        angle_Intersection = Vector3.Angle(FindVector(new Vector3(x_Intersection, 0, y_Intersection)), priorityObject.GetComponent<Hauling_1>().FindVector(new Vector3(x_Intersection, 0, y_Intersection)));

        Vector3 direction_Intersection = FindVector(new Vector3(x_Intersection, 0, y_Intersection)).normalized;
        Vector3 direction_Intersection_1 = priorityObject.GetComponent<Hauling_1>().FindVector(new Vector3(x_Intersection, 0, y_Intersection)).normalized;
        ...
        firstIndex_1 = priorityObject.GetComponent<Hauling_1>().FindFirstIndex(intersectionPoint);
        endIndex_1 = priorityObject.GetComponent<Hauling_1>().FindEndIndex(intersectionPoint);
        ...
        if (Warning == false)
        {
            ...
            // [1]
            if (length <= Vector3.Distance(intersectionPoint, FindFirstPoint(intersectionPoint)) && length_1 <= Vector3.Distance(intersectionPoint, priorityObject.GetComponent<Hauling_1>().FindFirstPoint(intersectionPoint)))
            {
                if (length <= Vector3.Distance(intersectionPoint, FindEndPoint(intersectionPoint)) && length_1 <= Vector3.Distance(intersectionPoint, priorityObject.GetComponent<Hauling_1>().FindEndPoint(intersectionPoint)))
                {
                    print("1-5");
                ...
                else if (length > Vector3.Distance(intersectionPoint, FindEndPoint(intersectionPoint)) && length_1 <= Vector3.Distance(intersectionPoint, priorityObject.GetComponent<Hauling_1>().FindEndPoint(intersectionPoint)))
                {
                    print("1-6");
                    ...
                    if (endIndex < path_Reverse.Count - 1)
                    {
                        ...
                        angle_new = Vector3.Angle(vector_new, priorityObject.GetComponent<Hauling_1>().FindVector(new Vector3(x_Intersection, 0, y_Intersection)));
            ...
            // [2]
            else if (length > Vector3.Distance(intersectionPoint, FindFirstPoint(intersectionPoint)) && length_1 <= Vector3.Distance(intersectionPoint, priorityObject.GetComponent<Hauling_1>().FindFirstPoint(intersectionPoint)))
            {
                if (length <= Vector3.Distance(intersectionPoint, FindEndPoint(intersectionPoint)) && length_1 <= Vector3.Distance(intersectionPoint, priorityObject.GetComponent<Hauling_1>().FindEndPoint(intersectionPoint)))
                {
                    print("2-5");
                ...
                else if (length > Vector3.Distance(intersectionPoint, FindEndPoint(intersectionPoint)) && length_1 <= Vector3.Distance(intersectionPoint, priorityObject.GetComponent<Hauling_1>().FindEndPoint(intersectionPoint)))
                {
                    ...
                    if (firstIndex > 0 && endIndex < path_Reverse.Count - 1)
                    {
                        ...
                        angle_new_second = Vector3.Angle(vector_new_second, priorityObject.GetComponent<Hauling_1>().FindVector(new Vector3(x_Intersection, 0, y_Intersection)));
                ...
                else if (length <= Vector3.Distance(intersectionPoint, FindEndPoint(intersectionPoint)) && length_1 > Vector3.Distance(intersectionPoint, priorityObject.GetComponent<Hauling_1>().FindEndPoint(intersectionPoint)))
                {
                    ...
                    else
                    {
                        ...
                        if (firstIndex > 0 && firstIndex_1 > 0 && endIndex_1 < path_Reverse_1.Count - 1)
                        {
                            ...
                            angle_new_third = Vector3.Angle(vector_new_third, priorityObject.GetComponent<Hauling_1>().FindVector(new Vector3(x_Intersection, 0, y_Intersection)));
            ...
            s1 = priorityObject.GetComponent<Hauling_1>().PointToTime(start_1_point);
            s2 = priorityObject.GetComponent<Hauling_1>().PointToTime(exit_1_point);
    ...
    void FixedUpdate()
    {
        ...
        if (GetComponent<Loading>().FinishiMessage() == true)
        {

            Model MyModel = new Model(MyEngine);
            largeTruckLoading = Convert.ToSingle(MyModel.MyScenario.GetLargeTruckLoading());
            smallTruckLoading = Convert.ToSingle(MyModel.MyScenario.GetSmallTruckLoading());

            timer_1 += Time.deltaTime;

            //when loading is finished
            if (timer_1 > largeTruckLoading)
            {
                //abi zoodtar reside
                if (priorityObject.GetComponent<Loading_1>().FinishiMessage() == false && flag3 == false)
                {
                    s1_new = s1 + (priorityObject.GetComponent<Loading_1>().GetTimeLablePath()[priorityObject.GetComponent<Loading_1>().Getpath().Count - 1] - priorityObject.GetComponent<Loading_1>().GetTime()) + smallTruckLoading;
                    s2_new = s2 + (priorityObject.GetComponent<Loading_1>().GetTimeLablePath()[priorityObject.GetComponent<Loading_1>().Getpath().Count - 1] - priorityObject.GetComponent<Loading_1>().GetTime()) + smallTruckLoading;
                ...
                else if (priorityObject.GetComponent<Loading_1>().FinishiMessage() == true && flag3 == false)
                {

                    //ghermez hanuz dar marhale Loading ast
                    if (priorityObject.GetComponent<Hauling_1>().GetTimer_1() <= smallTruckLoading)
                    {
                        s1_new = s1 + smallTruckLoading - priorityObject.GetComponent<Hauling_1>().GetTimer_1();
                        s2_new = s2 + smallTruckLoading - priorityObject.GetComponent<Hauling_1>().GetTimer_1();
                    ...
                    //ghermez loading ra tamam karde ast
                    else if (priorityObject.GetComponent<Hauling_1>().GetTimer_1() > smallTruckLoading)
                    {
                        if (s1 >= priorityObject.GetComponent<Hauling_1>().GetTime())
                        {
                            s1_new = s1 - priorityObject.GetComponent<Hauling_1>().GetTime();
                            s2_new = s2 - priorityObject.GetComponent<Hauling_1>().GetTime();

                            print("333333333333333331111111111111111111");
                            print(s1_new);
                            flag3 = true;
                        }
                        ...
                        else
                        {
                            ...
                            print("3333333333333333322222222222222222");
                            print(s2_new);
                ...
                if (!finish)
                {
                    ...
                    {
                        EditorUtility.DisplayDialog("Warning!", "There is not a way to solve this solution, so please change the starting and ending points of objects!", "ok");
                        showMsg2 = false;
                    }
