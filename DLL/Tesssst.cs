...
public class Tesssst : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        if (GetComponent<Loading>().FinishiMessage() == true)
        {
            ...
            {
                s1_new = s1 + (priorityObject.GetComponent<Loading_1>().GetTimeLablePath()[priorityObject.GetComponent<Loading_1>().Getpath().Count - 1] - priorityObject.GetComponent<Loading_1>().GetTime());
                s2_new = s2 + (priorityObject.GetComponent<Loading_1>().GetTimeLablePath()[priorityObject.GetComponent<Loading_1>().Getpath().Count - 1] - priorityObject.GetComponent<Loading_1>().GetTime());
