...
public class Hauling : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        string str = "Optimal Path from Loading Point to Dumping Point for for BLUE one : ";
        ...
        print($"Distance between Loading Point to Dumping Point for BLUE one: {InformedRRTStar.get_path_len(path) * 5:F3} m");
        ...
        {
            //EditorUtility.DisplayDialog("warning!", "There is no intersection point from Loading Site to Dumping Site in the path of two objects.", "ok");

            canvas = FindInActiveObjectByTag("Canvas5");
    ...
    void FixedUpdate()
    {
        ...
        if (GetComponent<Loading>().FinishiMessage() == true)
        {
            ...
            else if (priorityObject.GetComponent<Loading_1>().FinishiMessage() == true && flag3 == false && flag5 == false)
            {
                ...
                else if (priorityObject.GetComponent<Hauling_1>().GetTimer_1() > smallTruckLoading && flag4 == false)
                {
                ...
                if (flag4 == true && priorityObject.GetComponent<Hauling_1>().GetTimer_1() > smallTruckLoading && flag3 == false)
                {
                    timer_1 += Time.deltaTime;
            ...
            {
                timer_1 += Time.deltaTime;
                priorityObject.GetComponent<Hauling_1>().ChangeStartMessageToFalse();

                //abi loading ra tamam karde ast
                if (timer_1 > largeTruckLoading)
                {
                    //ghermez hanuz be loading point nareside ast
                    if (priorityObject.GetComponent<Loading_1>().FinishiMessage() == false)
                    {
                        ...
                        priorityObject.GetComponent<Hauling_1>().ChangeStartMessageToTrue();
                    ...
                    {
                        s1_new = s1 + smallTruckLoading;
                        s2_new = s2 + smallTruckLoading;
