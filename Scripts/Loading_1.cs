...
public class Loading_1 : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        string str = "Optimal Path from Starting Point to Loading Point for RED one : ";
        ...
        print($"Distance between Starting Point to Loading Point for RED one: {InformedRRTStar.get_path_len(path) * 5:F3} m");
